...
const Button: React.FC<ButtonProps> = ({
	...
	return (
		<button
			className={`cursor-pointer rounded-full border font-semibold shadow-xs transition-colors focus:ring-2 focus:ring-ring ${getVariantClass()} ${getSizeClass()} ${innerClass}`}
